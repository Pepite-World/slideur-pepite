...
class PESL_PepiteSlider extends ET_Builder_Module {
	...
	public function init() {
		...
		$this->settings_modal_toggles = array(
			...
			'custom_css' => array(
				'toggles' => array(
					'animation' => array(
						'title'    => esc_html__( 'Animation', 'pesl-pepite-slider' ),
						'priority' => 90,
					),
				),
			),
	...
	function get_fields() {
		$fields = array(
			'show_arrows'             => array(
				...
				'description'      => esc_html__( 'This setting will turn on and off the navigation arrows.', 'pesl-pepite-slider' ),
				'mobile_options'   => true,
				'hover'            => 'tabs',
			),
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		if ( ! $multi_view->has_value( 'show_copunt', 'on' ) ) {
		...
		$navigation = $show_arrows === 'on' ? '<div class="swiper-arrow-button swiper-button-prev"></div> <div class="swiper-arrow-button swiper-button-next"></div>' : '';
